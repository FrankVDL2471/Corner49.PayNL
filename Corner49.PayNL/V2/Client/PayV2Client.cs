...
using Corner49.PayNL.V2.DataTransferModels.ClearingAccounts;
using Corner49.PayNL.V2.DataTransferModels.Config;
using Corner49.PayNL.V2.DataTransferModels.ContactMethods;
using Corner49.PayNL.V2.DataTransferModels.Currencies;
using Corner49.PayNL.V2.DataTransferModels.DirectDebit;
using Corner49.PayNL.V2.DataTransferModels.Documents;
using Corner49.PayNL.V2.DataTransferModels.Ip;
using Corner49.PayNL.V2.DataTransferModels.Issuers;
using Corner49.PayNL.V2.DataTransferModels.Licenses;
...
using Corner49.PayNL.V2.DataTransferModels.Terminals;
...
public class PayV2Client : PayV2ClientBase, IPayV2Client {
	...
	public Task<SettlementResponse> GetClearingSettlements() => _httpClient.GetAsync<SettlementResponse>($"clearings/settlements")!;

	public Task<ClearingRecordsResponse> GetClearingRecords(string clearingId) => _httpClient.GetAsync<ClearingRecordsResponse>($"clearings/{clearingId}/records")!;
	...
	public Task<GetConfigResponse?> GetServiceConfig(string serviceId) => _httpClient.GetAsync<GetConfigResponse?>($"/services/config");
