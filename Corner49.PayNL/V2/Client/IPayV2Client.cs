...
public interface IPayV2Client {
	...
	Task<SettlementResponse> GetClearingSettlements();
	...
	/// </summary>
	/// <param name="queryParams">Use <see cref="ClearingSettlementFilter"/> too build your query parameter</param>
	/// <returns></returns>
	Task<ClearingRecordsResponse> GetClearingRecords(string clearingId);
	...
	Task<GetConfigResponse?> GetServiceConfig(string serviceId);
